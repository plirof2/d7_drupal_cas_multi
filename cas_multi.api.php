 ...
 * CAS accounts via the {cas_multi_user} mapping table. If the user does not exist
 * locally, and automatic registration is enabled, this name will be used
 * as the local Drupal user account name that's created.
 *
 ...
 *   - 'register_email': Set this to the email address that should be used
 *     when auto registering the user. If not set, the username is combined
 *     with the email hostname you specify in the CAS settings.
 ...
 *   - 'server_config': A stdClass containing details about the CAS server
 *     configuration this user authenticated against.
 */
function hook_cas_multi_user_alter(&$cas_user) {
 ...
 * @param $cas_server_config
 *   A stdClass containing details about the CAS server config the user
 *   authenticated against.
 */
function hook_cas_multi_user_presave(&$edit, $account, $cas_server_config) {
 ...
 */
function hook_cas_multi_phpcas_alter() {
